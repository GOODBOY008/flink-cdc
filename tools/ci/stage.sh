...
function get_test_modules_for_stage() {
    ...
    case ${stage} in
        ...
        ;;
        (${STAGE_E2E_1})
            echo "-pl $modules_e2e -Dtest=Db2E2eITCase,MongoE2eITCase,TiDBE2eITCase,PostgresE2eITCase,SqlServerE2eITCas,VitessE2eITCase"
        ;;
        (${STAGE_E2E_2})
            echo "-pl $modules_e2e -Dtest=MySqlE2eITCase,OracleE2eITCase"
        ;;
        (${STAGE_MISC})
