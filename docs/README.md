...
documentation of Flink CDC.

The documentation is included with the source of Flink CDC in order to ensure
...
* withTestClassifier: Includes `<classifier>tests</classifier>`. Useful when
  users should be pulling in Flink tests dependencies. This is mostly for the
